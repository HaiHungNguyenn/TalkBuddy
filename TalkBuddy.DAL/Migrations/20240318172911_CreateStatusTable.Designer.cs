...
namespace TalkBuddy.DAL.Migrations
{
    ...
    [Migration("20240318172911_CreateStatusTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TalkBuddy.Domain.Entities.ClientChatBoxStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ClientChatBoxId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClientChatBoxId");

                    b.HasIndex("MessageId");

                    b.ToTable("ClientChatBoxStatus", (string)null);
                });
            ...
            modelBuilder.Entity("TalkBuddy.Domain.Entities.ClientChatBoxStatus", b =>
                {
                    b.HasOne("TalkBuddy.Domain.Entities.ClientChatBox", "ClientChatBox")
                        .WithMany("MessageStatus")
                        .HasForeignKey("ClientChatBoxId")
                        .IsRequired();
